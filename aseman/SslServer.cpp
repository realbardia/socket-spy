...
SslServer::SslServer(QObject *parent) : AsemanAbstractTcpServer(parent),
...
{
    Handle h;
    h.handle = socketDescriptor;
    h.sslLocalCertificate = m_sslLocalCertificate;
    h.sslPrivateKey = m_sslPrivateKey;
    h.sslProtocol = m_sslProtocol;
